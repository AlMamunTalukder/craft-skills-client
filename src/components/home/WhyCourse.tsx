            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {whycourse.map((text, index) => (
                <motion.div
                  ...
                  className="flex items-start gap-5 p-4 bg-white border border-purple-100 rounded-[20px] shadow-[0_10px_40px_rgba(79,1,135,0.04)] hover:shadow-[0_20px_50px_rgba(79,1,135,0.1)] transition-all duration-500 group"
                >
                  ...
                  <p className="text-[#2D2D2D] text-lg md:text-[18px] leading-relaxed font-semibold group-hover:text-[#4F0187] transition-colors duration-300">
                    {text}
                  </p>
                </motion.div>
              ))}
