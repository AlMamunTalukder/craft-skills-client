...
// // --- Custom Hook to handle "In-View" visibility ---
...
//                 className={`group relative flex flex-col md:flex-row items-stretch rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-purple-100 bg-white shadow-sm hover:shadow-xl transition-all duration-700 transform-gpu
//                   ${
//                     isVisible
...
//                 {/* After Section */}
//                 <div className="flex-1 p-5 md:p-10 flex items-start gap-4 bg-gradient-to-br from-white to-purple-50/40">
...
//                       কোর্স করার পরে
//                     </span>
//                     <p className="text-slate-900 text-[16px] md:text-[18px] font-extrabold leading-snug">
//                       {item.after}
//                     </p>
//                   </div>
//                 </div>
...
const Transformation = () => {
  ...
  return (
    <section className="py-12 md:py-24 bg-[#FAF9FF] relative overflow-hidden">
      <Container>
        ...
        <div className="flex flex-col gap-4 md:gap-6 max-w-5xl mx-auto">
          {transformations.map((item, index) => {
            const { ref, isVisible } = useInView({ threshold: 0.05 }); // Lower threshold for mobile
            return (
              <div
                key={index}
                ref={ref}
              ...
              >
                {/* Before Section */}
                <div className="flex-1 p-6 md:p-8 flex items-start gap-4 bg-red-50/20 border-b md:border-b-0 md:border-r border-slate-100">
                ...
                {/* After Section */}
                <div className="flex-1 p-6 md:p-8 flex items-start gap-4 bg-gradient-to-br from-white to-purple-50/30">
                  <CheckCircle2
