        ...
        <div className="relative z-10 grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 max-w-6xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div
                className={`shrink-0 w-9 md:w-14 h-9 md:h-14 rounded-lg md:rounded-2xl bg-gradient-to-br ${step.gradient} text-white flex items-center justify-center shadow-[0_0_20px_rgba(0,0,0,0.3)] mb-2 md:mb-6 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
              >
                {step.icon}
              </div>
