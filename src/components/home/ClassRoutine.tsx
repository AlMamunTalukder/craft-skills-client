    ...
    <Container>
      <div className="mt-8 md:mt-24 md:mb-20">
                  ...
                  <div className="space-y-2 md:space-y-4 mt-auto">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-700 text-xs md:text-lg font-bold pt-1">
                          {routine.days}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-700 text-xs md:text-base font-bold pt-1">
                          {routine.time}
                        </p>
                      </div>
                    </div>
        ...
        {displaySchedule.holidays && (
          <div className="max-w-[1100px] mx-auto mt-5 md:mt-10">
            <div className="flex items-center justify-center gap-3 p-2 md:p-5 bg-[#2e1065] text-white rounded-2xl shadow-lg shadow-purple-100">
              <Bell className="w-5 h-5 text-purple-300 animate-bounce" />
              <span className="font-bold text-lg pt-1">
                {displaySchedule.holidays}
              </span>
            </div>
          </div>
