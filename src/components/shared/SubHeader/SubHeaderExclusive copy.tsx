...
export default function SubHeaderExclusive() {
            ...
            <div className="flex items-center gap-3 text-center md:text-left">
              ...
              <div>
                ...
                <p className="text-sm md:text-base font-bold text-white">
                  🚫 {activeBatch?.title || "১৯৯ টাকার অফারটি শেষ!"}
                </p>
                <p className="text-xs md:text-sm text-red-300 font-semibold">
                  {activeBatch?.description || "বর্তমান প্রাইস ৫,৫০০ টাকা"}
                </p>
              </div>
            </div>
  ...
  return (
    <div className="sticky top-0 z-50 w-full h-auto md:h-auto bg-black shadow-lg border-b border-[#F26422]/20 text-white py-0 md:py-1.5">
      <Container>
        <div className="flex flex-col md:flex-row items-center justify-between pt-2 md:pt-3 md:pb-1 gap-2 md:gap-0">
          <div className="flex items-center justify-center md:items-start flex-col text-center md:text-left md:px-2">
            {/* ✅ Use title directly from activeBatch */}
            <h3 className="text-[13px] md:text-[17px] leading-tight font-bold">
              {activeBatch?.title || "১৯৯ টাকায় ৫,৫০০ টাকার লাইভ মাস্টারক্লাস।"}
            </h3>
            
            {/* ✅ Use description directly from activeBatch */}
            <p className="text-[11px] md:text-[13px] text-[#F26422] font-medium opacity-90">
              {activeBatch?.description || "অফারটি শেষ হতে আর মাত্র কিছু সময় বাকি"}
            </p>
