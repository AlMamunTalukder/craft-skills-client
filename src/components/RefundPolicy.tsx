                ...
                <div className="space-y-8 bg-white/[0.02] border border-white/5 p-6 md:p-10 rounded-3xl backdrop-blur-md">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-purple-100/70 text-base leading-relaxed">
                            যেহেতু আমাদের মাস্টারক্লাসটি লাইভ অনুষ্ঠিত হয় এবং এর ফি অত্যন্ত সাশ্রয়ী, তাই সফলভাবে পেমেন্ট সম্পূর্ণ হওয়ার পর সাধারণ ক্ষেত্রে কোনো রিফান্ড বা পেমেন্ট ক্যান্সেলেশন দেওয়া সম্ভব নয়। এনরোল করার আগে কোর্স মডিউল এবং ডিটেইলস ভালোভাবে দেখে নেওয়ার অনুরোধ রইলো।
                        </p>
                    </div>
