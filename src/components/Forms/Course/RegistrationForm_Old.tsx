...
// export default function RegistrationForm_Old({
//   courses,
//   batch,
//   loading = false,
// }: Props) {
...
//             <div className="bg-[#370165]/80 backdrop-blur-md p-4 md:p-8 border-y border-white/20">
...
//             <div className="bg-[#370165]/60 backdrop-blur-md p-4 md:p-8 border-b border-white/20">
//               <h3 className="font-bold text-2xl text-white mb-6 flex items-center gap-2">
//                 <span className="bg-white/20 p-1.5 rounded-md">
...
//                         <div className="bg-white rounded-sm md:rounded-full p-2">
//                           <Image
//                             src={option.logo}
//                             alt={`${option.name} Logo`}
//                             width={36}
//                             height={36}
//                             className="w-10 md:w-8 h-8"
//                             priority
//                           />
//                         </div>
//                         <p className="hidden md:block font-bold text-white text-xl">
//                           {option.name}
//                         </p>
//                       </div>
//                       <div className="w-full md:mt-4 md:bg-white/10 md:p-3 rounded-lg">
...
//               <div className="mt-6 p-[6px] md:p-4 bg-yellow-400/10 border border-yellow-400/30 rounded-lg">
