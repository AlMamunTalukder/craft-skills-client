...
export default async function ResultsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      {/* Result Status – MAIN FOCUS */}
      <div
        className={`rounded-2xl ${config.bg} p-8 text-center mb-12`}
      >
        <Icon className={`${config.color} mx-auto mb-4`} size={56} />

        <h2
          className={`text-4xl font-bold tracking-tight ${config.color}`}
        >
          {result.status}
        </h2>
      ...
      {/* Feedback – SECONDARY BUT IMPORTANT */}
      {result.comments && (
