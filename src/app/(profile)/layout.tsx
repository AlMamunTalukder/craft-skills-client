...
import { LayoutDashboard, BookOpen, Star, Users, Award, LogOut, Menu, X, Home } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden bg-white border-b sticky top-0 z-40 p-4">
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleSignOut} className="p-2 text-red-600 hover:bg-red-50 rounded">
            <LogOut size={20} />
          </button>
        </div>
      </div>
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:block w-64 bg-gray-900 text-white h-screen sticky top-0">
          ...
          <div className="p-4 border-t border-gray-700">
            <Link href="/" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800">
              <Home size={20} />
              <span>Back to Home</span>
            </Link>
            <button onClick={handleSignOut} className="flex items-center gap-3 px-4 py-3 rounded-lg text-red-400 hover:bg-red-900 w-full mt-2">
              <LogOut size={20} />
              <span>Sign Out</span>
            </button>
          </div>
