    ...
    <div className="min-h-screen relative overflow-hidden bg-[#0F0F0F] py-5 md:py-10">
      ...
      <Container>
        <div className="relative z-10 max-w-md mx-auto">
          <div className="relative overflow-hidden rounded-2xl md:rounded-4xl border border-white/10 bg-white/5 backdrop-blur-2xl shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
            {/* ── HEADER ── */}
            <div className="relative px-6 pt-4 md:pt-3 pb-3 text-center border-b border-white/10 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="mx-auto mb-3 md:mb-2 w-10 md:w-15 h-10 md:h-15 rounded-full bg-gradient-to-br from-[#F26422] to-[#ff8c57] flex items-center justify-center shadow-[0_10px_40px_rgba(242,100,34,0.5)]">
                  <CheckCircle className="w-10 h-10 text-white" />
                </div>

                <h1 className="text-2xl md:text-3xl font-black leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#F26422] via-white to-[#F26422]">
            ...
            <div className="p-2 md:p-3 space-y-3">
              ...
              {(name|| phone || email || amount) && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-2 backdrop-blur-xl">
                  <p className="text-center text-lg md:text-2xl font-semibold text-white/90">
                    ধন্যবাদ, {name}
                  </p>
                  <div className="space-y-0 text-white/70 text-center">
                    {amount && (
                      <p>
              ...
              <div className="rounded-xl border border-[#F26422]/20 bg-[#013a1e] p-3">
                ...
                <div className="space-y-2">                 
                  ...
                  <Link
                    href={WHATSAPP_GROUP}
                    target="_blank"
                    className="group flex items-center justify-between rounded-xl border border-white/10 bg-white/12 hover:bg-[#25D366]/10 hover:border-[#25D366]/30 transition-all duration-300 px-2 md:px-5 py-2"
                  >
                    <div className="flex items-center gap-2 md:gap-4">
                      <div className="w-8 md:w-10 h-8 md:h-10 rounded-md md:rounded-lg bg-[#25D366]/15 flex items-center justify-center">
                        <FaWhatsapp className="text-[#25D366] text-lg md:text-2xl" />
                      </div>
                      <div>
              ...
              {/* CONTACT */}
              <div className="border border-[#F26422]/20 bg-[#141414] rounded-xl p-3 shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 bg-orange-300 border border-[#F26422]/20 rounded-full -mr-12 -mt-12 opacity-50"></div>

                <h4 className="font-bold text-white mb-3  md:text-lg flex items-center justify-center gap-2">
                  <span className="w-8 h-0.5 bg-orange-200"></span>
                  কোন সাহায্য প্রয়োজন?
                  <span className="w-8 h-0.5 bg-orange-200"></span>
                </h4>

                <div className="lg:flex gap-2 items-center content-center justify-center space-y-2 md:space-y-0">
                  <Button
                    // variant="outline"
                    className="w-full md:w-auto h-auto py-2 justify-start bg-white/5 border border-white/5 hover:border-orange-600 hover:bg-white/10 transition-all duration-300 group"
                    asChild
                  >
                    <Link href={telLink} className="flex items-center">
                      <div className="bg-orange-100 p-2 rounded-lg mr-2 group-hover:bg-orange-600 transition-colors">
                  ...
                  <Button
                    // variant="outline"
                    className="w-full md:w-auto h-auto py-2 justify-start bg-white/5 border border-white/5 hover:border-green-600 hover:bg-white/10 transition-all duration-300 group"
                    asChild
                  >
                    <Link
                      href={whatsappLink}
                    ...
                    >
                      <div className="bg-green-100 p-2 rounded-lg mr-2 group-hover:bg-[#25D366] transition-colors">
              ...
              <Link
                href="/exclusive"
                className="w-72 mx-auto group relative overflow-hidden flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#F26422] to-[#ff7b42] px-3 md:px-4 py-1 md:py-2 text-lg md:text-xl font-black text-white shadow-[0_10px_40px_rgba(242,100,34,0.4)] hover:scale-[1.02] transition-all duration-300"
              >
