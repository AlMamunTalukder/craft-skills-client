      ...
      <Container className="relative z-10">
        ...
        <div className="text-center mb-14 md:mb-20">
          ...
          <p className="text-white/60 mt-4 text-sm md:text-lg max-w-2xl mx-auto">
            আধুনিক কমিউনিকেশন, ভয়েস এবং পার্সোনালিটি ডেভেলপমেন্টের পূর্ণ রোডম্যাপ
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
          ...
          {learnings.map((item, i) => (
            <div
              key={i}
              className="group relative p-[1px] rounded-2xl bg-gradient-to-r from-[#F26422]/40 via-white/10 to-[#F26422]/40"
            >
              <div className="h-full rounded-2xl bg-[#353535]/80 backdrop-blur-xl p-5 md:p-6 border border-white/10 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-[#F26422]/40">
        ...
        <div className="mt-14 md:mt-20 text-center">
          <div className="inline-block px-6 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl">
