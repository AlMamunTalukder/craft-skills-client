...
export default function ReviewsMasonryWithSlider() {
    ...
    return (
      <div id="reviews" className="bg-[#4F0187] py-20">
        ...
        <div className="container mx-auto px-4 text-center">
          <p className="text-red-300">Failed to load reviews: {error}</p>
        </div>
      </div>
    );
  }
  ...
  if (reviews.length === 0) {
    return (
      <div id="reviews" className="bg-[#4F0187] py-20">
        <SectionTitle text="লিখিত মতামত" className="text-white" />
        <div className="container mx-auto px-4 text-center">
          <p className="text-white">No reviews available yet.</p>
        </div>
      </div>
    );
  }
