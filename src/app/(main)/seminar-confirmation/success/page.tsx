...
import { CheckCircle, Download, ArrowRight, PhoneCall, Mail } from "lucide-react";
...
export default function SeminarPDFSuccessPage() {
  ...
  // Google Drive PDF link - Direct download format
  const pdfDownloadLink = "https://drive.google.com/file/d/1_15yE0kN3j3RIShS7_DlH5S7IdCRbqeM/view";
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-8 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
          {/* Header */}
          <div className="relative bg-gradient-to-r from-[#4f0187] to-purple-800 p-8 text-center">
            {/* Decorative circles */}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100 mb-4">
                <h3 className="font-bold text-green-800 mb-2 text-lg">
                  {seminarTitle ? decodeURIComponent(seminarTitle) : "সেমিনার"} PDF
                </h3>
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold text-lg rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isDownloading ? (
                    <>
            ...
            <Link
              href="/"
              className="block w-full py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold text-center rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
            >
              হোমপেজে ফিরে যান
